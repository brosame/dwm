...
static const char col_bg0h[]        = "#1d2021";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg4, col_bg0h, col_bg1  },
	[SchemeSel]  = { col_fg0, col_blue, col_yellow },
	[SchemeUrg]  = { col_fg0, col_red, col_red },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg0h, "-nf", col_fg4, "-sb", col_blue, "-sf", col_fg0, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *passcmd[] = { "passmenu", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg0h, "-nf", col_fg4, "-sb", col_blue, "-sf", col_fg0, NULL };
